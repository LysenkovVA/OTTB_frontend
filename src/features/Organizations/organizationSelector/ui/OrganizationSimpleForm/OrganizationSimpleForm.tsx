...
import cls from "./OrganizationSimpleForm.module.scss";

export interface OrganizationSimpleFormProps {
    className?: string;
    form?: FormInstance;
}

export const OrganizationSimpleForm = memo(
    (props: OrganizationSimpleFormProps) => {
        ...
        return (
            <>
                ...
                <Form
                    ...
                    rootClassName={classNames(cls.OrganizationSimpleForm, {}, [
                        className,
                    ])}
                    layout={"vertical"}
                    disabled={isLoading}
